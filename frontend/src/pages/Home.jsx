...
function Home() {
  ...
  return (
    <div className="relative w-full h-screen">
        ...
        <nav className="bg-transparent flex items-center justify-between h-24">
          ...
          <div className="flex items-center">
            <InputGroup className="mr-6 pr-44">
              ...
              <Input
                className="flex flexbox m-auto rounded-lg p-1 pr-6 pl-6 text-black"
                type="text"
                placeholder="Search..."
                bg="gray.800"
                color="gray.300"
      ...
      <div className="pt-80">
        <section className="py-24 bg-gray-500 text-center font-sans">
        ...
        <section className="text-center pt-10 pb-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center">
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 p-4">
                <div className="p-6 bg-white rounded-lg shadow-md transition-transform transform hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50">
                  <h3 className="text-2xl font-bold mb-4 text-black">Real-Time Updates</h3>
                  <p className="text-gray-700">
      ...
      <div className="pb-20">
        <section className="flex pt-20 pl-52 font-sans">
      ...
      <section className="py-20 bg-gray-500 text-center font-sans">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-full md:w-1/3 p-4">
              <div className="p-6 bg-white rounded-lg shadow-md transition-transform transform hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50">
                <h3 className="text-2xl font-bold mb-4 text-black">2. Learn</h3>
                <p className="text-gray-700">
            ...
            <div className="w-full md:w-1/3 p-4">
              <div className="p-6 bg-white rounded-lg shadow-md transition-transform transform hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50">
                <h3 className="text-2xl font-bold mb-4 text-black">3. Implement</h3>
                <p className="text-gray-700">
      ...
      <section className="py-20 bg-teal-500 text-white text-center font-sans">
        <div className="max-w-5xl mx-auto">
